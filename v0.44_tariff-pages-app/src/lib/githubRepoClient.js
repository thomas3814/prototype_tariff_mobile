...
const DEFAULT_SOURCE_FILE_PATH = import.meta.env.VITE_GITHUB_SOURCE_FILE_PATH?.trim() || 'tariff-pages-app/source-data/tariff-source.xlsx';
const DEFAULT_SOURCE_FOLDER_URL = import.meta.env.VITE_GITHUB_SOURCE_FOLDER_URL?.trim()
  || 'https://github.com/thomas3814/prototype_tariff_mobile/tree/main/tariff-pages-app/source-data';
...
export function getGithubSourceContext() {
  const repository = CONFIGURED_REPOSITORY || inferRepositoryFromLocation() || 'thomas3814/prototype_tariff_mobile';
  ...
  const sourceFolderUrl = DEFAULT_SOURCE_FOLDER_URL;
