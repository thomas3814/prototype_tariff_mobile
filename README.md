...
> 이 프로젝트는 Vite base 경로를 저장소 이름에 맞춰 자동 계산하도록 구성되어 있어, 일반적인 fork/복사 배포에서는 별도 base 수정 없이 그대로 사용할 수 있습니다. (이번 프로젝트의 경우 엑셀 유첨 교체만 운영하므로 Fork 방식보다는 code zip 파일 다운로드 및 저장소 생성후 다른 사용자에게 업로드 권한을 부여하는 방법을 추천드립니다.) 
